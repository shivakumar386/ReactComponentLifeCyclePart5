...
// import ImageItem from './Components/ImageItems/ImageItem'
...
//       changeImage: imagesList[0],
//       score: 0,
//       initialImageList: imagesList,
//       didWin: true,
//     }
//   }
...
//     const randomImage =
//       imagesList[Math.floor(Math.random() * initialImageList.length)]
//     return randomImage
//   }

//   clickImageId = id => {
//     const {changeImage, count} = this.state
//     const randomImage = this.randomImageDisplay()
//     if (count > 0) {
//       if (changeImage.id === id) {
...
//   render() {
//     const {count, score, changeImage, didWin} = this.state
//     const filteredTabItems = this.displayTabItems()
...
//               <img
//                 src={changeImage.imageUrl}
//                 alt="match"
//                 className="large-image"
//               />
//             </div>
//             <ul className="ul-tab-items">
...
//               ))}
//             </ul>
//             <div className="ul-image-container">
//               <ul className="ul-image-item">
//                 {filteredTabItems.map(eachImage => (
//                   <ImageItem
//                     clickImageId={this.clickImageId}
...
//           </div>
//         ) : (
//           <GameOver score={score} resettingGame={this.resettingGame} />
//         )}
//       </div>
//     )
//   }
